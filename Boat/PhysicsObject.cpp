...
PhysicsObject::PhysicsObject(string m, string t, string s, glm::vec3 position, glm::vec3 direction, glm::vec3 up) : GameObject(m, t, s, position, direction, up), physInit(FALSE) { collisionType = "default"; }
