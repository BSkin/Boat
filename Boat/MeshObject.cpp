...
MeshObject::MeshObject(string m, string t, string s, glm::vec3 position, glm::vec3 direction, glm::vec3 up, int colGroup, int colMask) : RigidObject(m, t, s, position, direction, up, "model", colGroup, colMask)
{
